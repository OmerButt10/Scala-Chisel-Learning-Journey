id: file://<WORKSPACE>/src/main/scala/Lab5/L1.scala:[1104..1107) in Input.VirtualFile("file://<WORKSPACE>/src/main/scala/Lab5/L1.scala", "import chisel3._
import chisel3.util._
import chisel3.iotesters.{Driver,PeekPokeTester}

class ALU ( width_parameter : Int ) extends Module {
al io = IO ( new IO_Interface ( width_parameter ) )
io . alu_out := 0. U
